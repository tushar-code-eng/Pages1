...
const Team = () => {
    return (
        <div className='p-5 xl:h-screen flex flex-col items-center justify-center'>
            ...
            <div className='xl:flex-row flex flex-col mt-20 w-full items-center justify-around flex-wrap'>
